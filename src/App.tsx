...
function App() {
  ...
  return (
    <div className="App">
        ...
        {/* <!--Footer container--> */}
        <footer
          className="flex flex-col items-center bg-white text-center text-white dark:bg-white">
          <div className="container pt-9">
            <div className="mb-9 flex justify-center">
              ...
              {/* twitter / x.com */}
              <a href="https://twitter.com/warrenwangg" target="_blank" rel="noopener noreferrer" className="mr-9 text-neutral-800 dark:text-neutral-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4"
                  fill="#4f46e5"
